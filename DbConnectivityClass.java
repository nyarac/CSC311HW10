...
public class DbConnectivityClass {
    final static String DB_NAME="csc311coursenc";
        MyLogger lg= new MyLogger();
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311coursenc.mariadb.database.azure.com";//update this server name
        final static String DB_URL = "jdbc:mysql://server.mariadb.database.azure.com/"+DB_NAME;//update this database name
        final static String USERNAME = "csc311admin@csc311coursenc";// update this username
        final static String PASSWORD = "Prplpan1!";// update this password
